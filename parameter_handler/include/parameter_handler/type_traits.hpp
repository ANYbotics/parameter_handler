...
template <typename ValueType_>
struct is_fixed_size_eigen_matrix<
    ValueType_, typename std::enable_if<is_eigen_matrix<ValueType_>::value && ValueType_::RowsAtCompileTime != Eigen::Dynamic &&
                                        ValueType_::ColsAtCompileTime != Eigen::Dynamic>::type> : std::true_type {};
